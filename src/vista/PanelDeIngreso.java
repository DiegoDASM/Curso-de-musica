...
public class PanelDeIngreso extends JFrame {
	...
	public void initcomponents () {
		...
		lblImagenMicro.setIcon(new ImageIcon("C:\\Users\\Diego\\Desktop\\gratis-png-microfono.png"));
		...
		lblLogo.setIcon(new ImageIcon("C:\\Users\\Diego\\Downloads\\WhatsApp Image 2022-04-10 at 9.44.46 PM.jpeg"));
		...
		btnIngresar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(txtnombre.getText().equals("pepe") && claveFinal.equals("123")) {
					...
					Plantillaprincipal p = new Plantillaprincipal();
					p.setVisible(true);
